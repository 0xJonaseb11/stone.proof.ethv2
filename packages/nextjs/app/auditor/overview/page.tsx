...
// NoRoleBanner component (styled to match refiner overview warning banner)
const NoRoleBanner = ({
  address,
  isLoadingRefresh,
  onRefresh,
...
export default function Page() {
  ...
  const handleRefreshAccess = async () => {
    ...
    try {
      ...
      if (data) {
        ...
        notification.error("Still no auditor role. Contact administrator.");
      }
    } catch (e) {
  ...
  useEffect(() => {
    ...
    }, 500); // Match refiner overview loading time
  ...
  return (
    <div className="px-4 sm:px-6 md:px-10 flex flex-col gap-6 sm:gap-8 md:gap-10">
      {/* Show NoRoleBanner if connected but no auditor role */}
