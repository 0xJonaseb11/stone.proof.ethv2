...
export interface TokenizationInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: "getTokenDetails", values: [BigNumberish]): string;
  encodeFunctionData(functionFragment: "getTokenIdByMineralId", values: [string]): string;
  ...
  encodeFunctionData(functionFragment: "mineralToToken", values: [string]): string;
  encodeFunctionData(functionFragment: "mintToken", values: [AddressLike, string, string]): string;
  ...
  encodeFunctionData(functionFragment: "revokeToken", values: [BigNumberish, string]): string;
  ...
  decodeFunctionResult(functionFragment: "getTokenDetails", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "getTokenIdByMineralId", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "mineralToToken", data: BytesLike): Result;
...
export namespace MintedEvent {
  export type InputTuple = [tokenId: BigNumberish, mineralId: string, to: AddressLike];
...
export interface Tokenization extends BaseContract {
  ...
  getTokenIdByMineralId: TypedContractMethod<[mineralId: string], [bigint], "view">;
  ...
  mintToken: TypedContractMethod<[to: AddressLike, mineralId: string, details: string], [void], "nonpayable">;
  ...
  revokeToken: TypedContractMethod<[tokenId: BigNumberish, reason: string], [void], "nonpayable">;
  ...
  transferOwnership: TypedContractMethod<[tokenId: BigNumberish, newOwner: AddressLike], [void], "nonpayable">;

  updateMetadata: TypedContractMethod<[tokenId: BigNumberish, newDetails: string], [void], "nonpayable">;

  updateToken: TypedContractMethod<
    [tokenId: BigNumberish, arg1: string, audited: boolean, inspected: boolean, purchased: boolean],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(nameOrSignature: "getTokenDetails"): TypedContractMethod<
    [tokenId: BigNumberish],
    [
      [bigint, string, string, boolean, boolean, boolean, boolean, string] & {
        id: bigint;
    ...
    "view"
  >;
  getFunction(nameOrSignature: "getTokenIdByMineralId"): TypedContractMethod<[mineralId: string], [bigint], "view">;
  getFunction(
  ...
  getFunction(nameOrSignature: "mineralHistories"): TypedContractMethod<
    ...
    "view"
  >;
  getFunction(nameOrSignature: "mineralToToken"): TypedContractMethod<[arg0: string], [bigint], "view">;
  getFunction(
    nameOrSignature: "mintToken",
  ): TypedContractMethod<[to: AddressLike, mineralId: string, details: string], [void], "nonpayable">;
  ...
  ): TypedContractMethod<[tokenId: BigNumberish, reason: string], [void], "nonpayable">;
  getFunction(
  ...
  ): TypedContractMethod<[tokenId: BigNumberish, newOwner: AddressLike], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "updateMetadata",
  ): TypedContractMethod<[tokenId: BigNumberish, newDetails: string], [void], "nonpayable">;
  getFunction(
  ...
  getEvent(
    key: "Minted",
  ): TypedContractEvent<MintedEvent.InputTuple, MintedEvent.OutputTuple, MintedEvent.OutputObject>;
  getEvent(
  ...
  getEvent(
    key: "Transferred",
  ): TypedContractEvent<TransferredEvent.InputTuple, TransferredEvent.OutputTuple, TransferredEvent.OutputObject>;
  getEvent(
  ...
  getEvent(
    key: "Updated",
  ): TypedContractEvent<UpdatedEvent.InputTuple, UpdatedEvent.OutputTuple, UpdatedEvent.OutputObject>;
  ...
  filters: {
    ...
    >;
    Updated: TypedContractEvent<UpdatedEvent.InputTuple, UpdatedEvent.OutputTuple, UpdatedEvent.OutputObject>;
  };
}
