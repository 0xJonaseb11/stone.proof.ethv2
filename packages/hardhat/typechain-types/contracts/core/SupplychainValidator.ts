...
export interface SupplychainValidatorInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: "logValidationResult", values: [string]): string;
  ...
  encodeFunctionData(functionFragment: "validateInspectionOperation", values: [string, AddressLike]): string;
  encodeFunctionData(functionFragment: "validateMiningOperation", values: [string]): string;
  encodeFunctionData(functionFragment: "validatePurchaseOperation", values: [string, AddressLike]): string;
  encodeFunctionData(functionFragment: "validateRefiningOperation", values: [string]): string;
  encodeFunctionData(functionFragment: "validateSupplychain", values: [string]): string;
  encodeFunctionData(functionFragment: "validateTransportationOperation", values: [string, AddressLike]): string;
  ...
  decodeFunctionResult(functionFragment: "logValidationResult", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "validateInspectionOperation", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "validateMiningOperation", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "validatePurchaseOperation", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "validateRefiningOperation", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "validateSupplychain", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "validateTransportationOperation", data: BytesLike): Result;
}
...
export namespace OperationValidatedEvent {
  export type InputTuple = [actor: AddressLike, operation: string, timestamp: BigNumberish];
  export type OutputTuple = [actor: string, operation: string, timestamp: bigint];
  export interface OutputObject {
    actor: string;
    operation: string;
    timestamp: bigint;
...
export namespace SupplychainValidatedEvent {
  export type InputTuple = [validator: AddressLike, isValid: boolean, mineralId: string];
  export type OutputTuple = [validator: string, isValid: boolean, mineralId: string];
  export interface OutputObject {
    validator: string;
    isValid: boolean;
    mineralId: string;
...
export interface SupplychainValidator extends BaseContract {
  ...
  logValidationResult: TypedContractMethod<[mineralId: string], [[boolean, string]], "nonpayable">;
  ...
  validateInspectionOperation: TypedContractMethod<[mineralId: string, inspector: AddressLike], [void], "nonpayable">;

  validateMiningOperation: TypedContractMethod<[mineralId: string], [void], "nonpayable">;

  validatePurchaseOperation: TypedContractMethod<[mineralId: string, buyer: AddressLike], [void], "nonpayable">;

  validateRefiningOperation: TypedContractMethod<[mineralId: string], [void], "nonpayable">;
  ...
  validateTransportationOperation: TypedContractMethod<[mineralId: string, to: AddressLike], [void], "nonpayable">;
  ...
  ): TypedContractMethod<[mineralId: string], [[boolean, string]], "nonpayable">;
  ...
  ): TypedContractMethod<[mineralId: string, inspector: AddressLike], [void], "nonpayable">;
  getFunction(
  ...
  ): TypedContractMethod<[mineralId: string, buyer: AddressLike], [void], "nonpayable">;
  getFunction(
  ...
  ): TypedContractMethod<[mineralId: string, to: AddressLike], [void], "nonpayable">;
