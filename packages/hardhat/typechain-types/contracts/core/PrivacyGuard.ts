...
export interface PrivacyGuardInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: "addSensitiveData", values: [BigNumberish, string]): string;
  ...
  encodeFunctionData(functionFragment: "deleteSensitiveData", values: [BigNumberish]): string;
  ...
  encodeFunctionData(functionFragment: "getSensitiveData", values: [BigNumberish]): string;
  ...
  decodeFunctionResult(functionFragment: "addSensitiveData", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "deleteSensitiveData", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "getSensitiveData", data: BytesLike): Result;
...
export namespace DataAccessAttemptEvent {
  export type InputTuple = [accessor: AddressLike, dataId: BigNumberish, success: boolean];
  export type OutputTuple = [accessor: string, dataId: bigint, success: boolean];
  export interface OutputObject {
    accessor: string;
    dataId: bigint;
    success: boolean;
...
export interface PrivacyGuard extends BaseContract {
  ...
  addSensitiveData: TypedContractMethod<[dataId: BigNumberish, encryptedContent: string], [void], "nonpayable">;
  ...
  deleteSensitiveData: TypedContractMethod<[dataId: BigNumberish], [void], "nonpayable">;
  ...
  getSensitiveData: TypedContractMethod<[dataId: BigNumberish], [string], "nonpayable">;
  ...
  ): TypedContractMethod<[dataId: BigNumberish, encryptedContent: string], [void], "nonpayable">;
  ...
  getFunction(nameOrSignature: "getSensitiveData"): TypedContractMethod<[dataId: BigNumberish], [string], "nonpayable">;
  getFunction(
