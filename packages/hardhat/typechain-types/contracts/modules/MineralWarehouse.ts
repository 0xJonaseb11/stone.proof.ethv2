...
export interface MineralWarehouseInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: "addAcceptedToken", values: [AddressLike]): string;
  ...
  encodeFunctionData(functionFragment: "getMineralPriceInToken", values: [string, AddressLike]): string;
  ...
  encodeFunctionData(functionFragment: "isMineralMarketReady", values: [string]): string;
  encodeFunctionData(functionFragment: "isMineralRegistered", values: [string]): string;
  encodeFunctionData(functionFragment: "list_Mineral_ForSale", values: [string, string]): string;
  ...
  decodeFunctionResult(functionFragment: "getMineralPriceInToken", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "isMineralMarketReady", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "isMineralRegistered", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "list_Mineral_ForSale", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "purchase_mineral", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "store_refined_mineral_to_warehouse", data: BytesLike): Result;
...
export namespace MineralListedForSaleEvent {
  export type InputTuple = [mineralId: string, price: string, lister: AddressLike];
...
export namespace MineralSoldEvent {
  export type InputTuple = [mineralId: string, buyer: AddressLike, seller: AddressLike, soldAt: BigNumberish];
  export type OutputTuple = [mineralId: string, buyer: string, seller: string, soldAt: bigint];
  export interface OutputObject {
    mineralId: string;
    buyer: string;
    seller: string;
...
export namespace MineralStoredEvent {
  export type InputTuple = [mineralId: string, refiner: AddressLike, storedAt: BigNumberish];
  export type OutputTuple = [mineralId: string, refiner: string, storedAt: bigint];
  export interface OutputObject {
    mineralId: string;
    refiner: string;
    storedAt: bigint;
...
export interface MineralWarehouse extends BaseContract {
  ...
  addAcceptedToken: TypedContractMethod<[_token: AddressLike], [void], "nonpayable">;
  ...
  getMineralPriceInToken: TypedContractMethod<[_mineralId: string, token: AddressLike], [bigint], "view">;
  ...
  isMineralMarketReady: TypedContractMethod<[_mineralId: string], [boolean], "view">;

  isMineralRegistered: TypedContractMethod<[mineralId: string], [boolean], "nonpayable">;

  list_Mineral_ForSale: TypedContractMethod<[_mineralId: string, _price: string], [void], "nonpayable">;
  ...
  purchase_mineral: TypedContractMethod<
    [_mineralId: string, method: BigNumberish, token: AddressLike, amount: BigNumberish],
    [void],
    "payable"
  >;
  ...
  store_refined_mineral_to_warehouse: TypedContractMethod<
    [_mineralId: string, _priceETH: BigNumberish, tokens: AddressLike[], prices: BigNumberish[]],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(nameOrSignature: "acceptedTokens"): TypedContractMethod<[arg0: AddressLike], [boolean], "view">;
  getFunction(nameOrSignature: "addAcceptedToken"): TypedContractMethod<[_token: AddressLike], [void], "nonpayable">;
  ...
  ): TypedContractMethod<[_mineralId: string, token: AddressLike], [bigint], "view">;
  ...
  getFunction(nameOrSignature: "isMineralMarketReady"): TypedContractMethod<[_mineralId: string], [boolean], "view">;
  getFunction(
  ...
  ): TypedContractMethod<[_mineralId: string, _price: string], [void], "nonpayable">;
  ...
  getEvent(
    key: "MineralSold",
  ): TypedContractEvent<MineralSoldEvent.InputTuple, MineralSoldEvent.OutputTuple, MineralSoldEvent.OutputObject>;
  getEvent(
    key: "MineralStored",
  ): TypedContractEvent<MineralStoredEvent.InputTuple, MineralStoredEvent.OutputTuple, MineralStoredEvent.OutputObject>;
  getEvent(
